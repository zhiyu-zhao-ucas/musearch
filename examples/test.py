...
if __name__=="__main__":
    ...
    explorer = GWG(model=sampler, rounds=10, sequences_batch_size=10, model_queries_per_batch=10, temperature=0.1, starting_sequence=starting_sequence, alphabet=alphabet)
