...
if __name__ == '__main__':
    ...
    for landscape in landscapes:
        for sequences_batch_size, model_queries_per_batch in [(100, 5000)]:
            ...
            if args.cnn:
                method_list = ['adalead', 'cmaes', 'dynappo', 'musearch', 'BO', 'cbas', 'evoplay', 'pex', 'pure_random']
                dirichlet_ppo_list = ['musearch']
            else:
                method_list = ['pure_random', 'adalead_gt', 'BO_gt', 'musearch_gt', 'cbas_gt', 'evoplay_gt', 'dynappo_gt', 'cmaes_gt', 'cbas_gt']
