    ...
    for landscape in ['aav', 'rna', 'gfp', 'tf', 'rosetta']:
        for sequences_batch_size, model_queries_per_batch in [(100, 5000)]:
            ...
            if args.cnn:
                ...
                method_list = ['adalead_gt', 'cbas_gt', 'cmaes_gt', 'dynappo_gt', 'BO_gt', 'dirichlet_ppo', 'dirichlet_ppo_update_starting_sequence', 'test']
                dirichlet_ppo_list = ['dirichlet_ppo', 'dirichlet_ppo_update_starting_sequence', 'test']
            ...
            # for method in ['adalead_gt', 'cbas_gt', 'cmaes_gt', 'dynappo_gt', 'BO_gt', 'dirichlet_ppo', 'dirichlet_ppo_update_starting_sequence', 'test']:
                ...
                # if method in ['dirichlet_ppo', 'dirichlet_ppo_update_starting_sequence', 'test']:
                    if args.cnn:
                        file_name = get_latest_csv(f'/home/v-zhaozhiyu/code/FLEXS/efficiency/{method}/{landscape}')
