...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        def policy_from_name_or_policy(policy):
            if isinstance(policy, str):
                return self._get_policy_from_name(policy)
            else:
                return policy

        self.for_protein = for_protein
        
        if for_protein:
            self.sub_step_observation_spaces1 = policy_kwargs['sub_step_observation_spaces1']
            self.sub_step_observation_spaces2 = policy_kwargs['sub_step_observation_spaces2']
            self.sub_step_action_spaces1 = policy_kwargs['sub_step_action_spaces1']
            self.sub_step_action_spaces2 = policy_kwargs['sub_step_action_spaces2']
            del policy_kwargs['sub_step_observation_spaces1']
            del policy_kwargs['sub_step_observation_spaces2']
            del policy_kwargs['sub_step_action_spaces1']
            del policy_kwargs['sub_step_action_spaces2']
            self.policy_class = policy_from_name_or_policy(policy[0])
            self.policy_class2 = policy_from_name_or_policy(policy[1])
        else:
            self.policy_class = policy_from_name_or_policy(policy)
