...
class DynaPPO(flexs.Explorer):
    ...
    def propose_sequences(
        ...
        print(f"self.tf_env.landscape.cost: {self.tf_env.landscape.cost}, previous_landscape_cost: {previous_landscape_cost}, experiment_based_training_budget: {experiment_based_training_budget}")
        while (
            self.tf_env.landscape.cost - previous_landscape_cost
            < experiment_based_training_budget
        ):
            print(f"self.tf_env.landscape.cost: {self.tf_env.landscape.cost}, previous_landscape_cost: {previous_landscape_cost}, experiment_based_training_budget: {experiment_based_training_budget}")
            print(f"self.tf_env.model.cost: {self.model.cost}")
            collect_driver.run()
        ...
        for _ in range(self.num_model_rounds):
            print(f"self.model.cost: {self.model.cost}, previous_model_cost: {previous_model_cost}, model_queries_per_batch: {self.model_queries_per_batch}, self.num_model_rounds: {self.num_model_rounds}")
            ...
            while self.model.cost - previous_round_model_cost < int(
                ...
                collect_driver.run()
                print("self.model.cost: ", self.model.cost)
