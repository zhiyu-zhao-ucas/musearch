...
class Explorer(abc.ABC):
    ...
    def run(
        self, landscape: flexs.Landscape, verbose: bool = False
        ...
        for r in range_iterator(1, self.rounds + 1):
            ...
            print(f"explore.py 173 seqs: {seqs}, len(seqs): {len(seqs)}")
            print(f"explore.py 174 preds: {preds}, len(preds): {len(preds)}")
            print(f"explore.py 175 true_score: {true_score}, len(true_score): {len(true_score)}")
            print(f"explore.py 176 r: {r}")
            print(f"explore.py 177 self.model.cost: {self.model.cost}")
            print(f"explore.py 178 len(sequences_data): {len(sequences_data)}")
            print(f"explore.py 179 len(seqs): {len(seqs)}")
