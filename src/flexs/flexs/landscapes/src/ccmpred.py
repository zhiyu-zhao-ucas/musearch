...
class CCMPredEncoder(object):
    def __init__(self, ccmpred_output=None, seq_len=None):
        ...
        self.vocab_index1 = vocab.CCMPRED_AMINO_ACID_INDEX1
    ...
    def encode_pair(self, sequences, mode = 'train'):
        index_encoded = self.index_encoding(sequences, self.vocab_index)    
        return all_sequence_pairwise_profile((self.eij, index_encoded))
